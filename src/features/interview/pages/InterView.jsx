    ...
    <div className="interview-page">
      ...
      <section className="interview-hero">
        <div className="hero-content">
          <h1 className="hero-title">Your Interview Preparation Guide</h1>
          <p className="hero-subtitle">
            Ace your <span className="hero-highlight">{report.title}</span> interview with personalized strategies, targeted questions, and a proven preparation roadmap.
          </p>
        </div>
      </section>
      ...
      <header className="interview-header">
        ...
        <p className="subtitle">Match Score: <b>{report.matchScore}%</b></p>
      </header>
