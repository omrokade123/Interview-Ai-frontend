...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    if (!uploadedFile && !selfDescription) {
      ...
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <p className="hero__sub" ref={heroSubRef}>
            Drop in a job description, upload your resume, and let our AI
            generate a hyper-personalised strategy — technical questions,
            behavioural prep, skill gap analysis, and a day-by-day roadmap. In
            30 seconds.
          </p>
